...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['app-administrator', 'rider', 'driver', 'customer-support', 'business-owner'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Rides', path: '/rides', entity: 'ride', service: AccessServiceEnum.PROJECT, icon: FiBox },
