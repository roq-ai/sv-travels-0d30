            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                {hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="User Rating Rider Id Touser"
                    text={
                      <Link as={NextLink} href={`/users/view/${data?.user_rating_rider_idTouser?.id}`}>
                        {data?.user_rating_rider_idTouser?.email}
                      </Link>
                    }
                  />
                )}
                {hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="User Rating Driver Id Touser"
                    text={
                      <Link as={NextLink} href={`/users/view/${data?.user_rating_driver_idTouser?.id}`}>
                        {data?.user_rating_driver_idTouser?.email}
                      </Link>
                    }
                  />
                )}
